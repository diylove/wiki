...
- 💬 语言：面向公众、面向本领域之外的人、面向实践者
- 🔗 链接：这是一个独立项目，不属于任何商业或非商业机构。我们相信原初的互联网精神，会通过汇聚和标签大量地使用内部和外部链接，链接不同领域、不同机构、不同地方和时期的活动指南。
- 🗃️ 存档：个人层面，你可以随时下载或复制整个维基。网络层面，这个维基存储在世界上最大的开源平台GitHub，在全球多地的数据中心有多份副本。同时有另外两处非营利组织托管的存档，地址在[Internet Archive](https://web.archive.org/web/*/https://github.com/diylove/wiki/issues/) 和 [Software Heritage](https://archive.softwareheritage.org/browse/origin/?origin_url=https://github.com/diylove/wiki) （我们还加入了GitHub Archive Program，意味着几年后它会像其它无数个开源项目一样以五百年寿命的媒介存入北极地下永久冻土层）。不同于平均寿命只有几年的各种国内互联网商业平台（还记得人人网吗？）或独立站点，你所贡献的知识可以更稳定和可靠地存在，比一个APP、一个网站、一个机构、一个人更长久。
